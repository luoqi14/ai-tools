...
const rainbowButtonVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        default:
          "border-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-[length:200%] text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 animate-rainbow before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:animate-rainbow before:bg-gradient-to-r before:from-blue-500 before:via-purple-500 before:to-pink-500 before:[filter:blur(0.75rem)]",
        outline:

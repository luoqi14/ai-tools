        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {!currentImageUrl && !result && (
              <div className="relative flex items-center justify-center h-full border-2 border-dashed border-muted-foreground/25 rounded-lg overflow-hidden">
                ...
                <BorderBeam size={800} duration={12} className="rounded-lg" />
              </div>
            )}
            ...
            {currentImageUrl && !result && (
              <div className="flex items-center justify-center h-full">
                <div className="relative rounded-lg overflow-hidden">
                  ...
                  />
                  <BorderBeam size={100} duration={8} className="rounded-lg" />
                </div>
              </div>
            )}
              ...
              <Sheet open={imageDrawerOpen} onOpenChange={setImageDrawerOpen}>
                ...
                <SheetContent side="left" className="w-80">
                  ...
                  <div className="space-y-4 mt-6">
                    ...
                    {/* 自定义URL */}
                    <BlurFade delay={0.1 + PRESET_IMAGES.length * 0.05} inView>
                      <Input
                        type="url"
              ...
              >
                ...
                <SheetContent side="right" className="w-80 flex flex-col">
                  <SheetHeader>
                    ...
                    <SheetDescription>选择处理模式并调整参数</SheetDescription>
                  </SheetHeader>
                  ...
                  <div className="flex flex-col flex-1 mt-6 overflow-hidden">
                    <div className="flex-1 overflow-y-auto space-y-6 pr-2">
                        ...
                        <div>
                          ...
                          <Select value={presetId} onValueChange={setPresetId}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="MTyunxiu1b2c8f8224">
                                牙齿贴面
                              </SelectItem>
                            </SelectContent>
                          </Select>
                      ...
                      {mode === "custom" && (
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <h3 className="text-sm font-medium">自定义参数</h3>
                            <Button
                              variant="outline"
                              size="sm"
                          ...
                          <div className="space-y-3">{parameterGroups}</div>
                        </div>
                      )}
                    </div>
                  </div>

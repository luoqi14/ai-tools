              ...
              <CardContent>
                {functionsData && (
                  ...
                  >
                    {/* 标签页导航 */}
                    <div className="mb-6">
                      <div className="w-full bg-gray-100/50 p-2 rounded-lg">
                          ...
                          {Object.entries(functionsData.parameter_groups).map(
                            ([key, group]) => (
                              <TabsTrigger
                                key={key}
                                value={key}
                                className="flex flex-col items-center justify-center p-3 min-h-[80px] text-xs font-medium transition-all data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:border-purple-200 hover:bg-white/70 cursor-pointer border border-transparent rounded-md relative z-10 w-full"
                              >

...
export default function MeituProcessor() {
  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      if (processingMode === "preset") {
        // 使用预设ID模式
        result = await api.processMeituImageWithPreset(selectedImage, presetId);
      } else {
        // 使用全参数模式
        ...
        result = await api.processMeituImage(requestData);
      }
  ...
  }, [selectedImage, parameters, processingMode, presetId, pollTaskStatus]);
